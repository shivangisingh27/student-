...
public class main {
    ...
    //private static Scanner object called "input" that will be used to accept user input from the console.
    ...
    private static void searchByPosition() {
        ...
        // This line reads a string input from the user and assigns it to the variable 'position'.
        input.nextLine(); // Consume newline left-over from input.nextInt()
    ...
    private static void updateStudent() {
        ...
        String prn = input.nextLine();
        // This line reads a string input from the user and assigns it to the variable 'prn'.
